...
// roles-data.js (window.NEXORA_PERMISSIONS). This file is the one that is
...
module.exports = { ROLE_PERMISSIONS, normalizeRole, getPermissions, hasPermission, hasAnyPermission };
